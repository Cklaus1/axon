...
**57 controls tracked; 10 engine states unknown or silently-ignored.**

| control | category | interp | native | wasm | guest | status |
|---|---|---|---|---|---|---|
| `AXON_AI_API_KEY` | ai-routing/diagnostic | ✓ | ✓ | n/a | **?** | native-closed |
| `AXON_AI_BASE_URL` | ai-routing/diagnostic | ✓ | ✓ | n/a | **?** | native-closed |
| `AXON_AI_MOCK` | ai-routing/diagnostic | ✓ | ✓ | n/a | **?** | native-closed |
| `AXON_AI_MODEL_BALANCED` | ai-routing/diagnostic | ✓ | ✓ | n/a | **?** | native-closed |
| `AXON_AI_PROVIDER` | ai-routing/diagnostic | ✓ | ✓ | n/a | **?** | native-closed |
| `AXON_NATIVE_TRACE` | ai-routing/diagnostic | ✓ | ✓ | n/a | **?** | native-closed |
