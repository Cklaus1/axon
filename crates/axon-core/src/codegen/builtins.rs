...
impl<'ctx> super::Codegen<'ctx> {
    ...
    pub fn declare_builtins(&mut self) {
        ...
        // R1d slice 2 out-param-synthesis extension (2026-07-20): the str-returning
        // out-param wrapper family (str_reverse/str_to_upper/…) that slice 1 couldn't cover.
        self.declare_str_out_externs();
        ...
        // str_reverse / str_digits_only moved to the STR_OUT_EXTERNS synthesis table
        // (codegen/builtin_externs.rs) — R1d slice 2 out-param-synthesis extension. Was
        // previously hand-written here; see that file's StrOutSig doc comment.
    ...
    pub(super) fn declare_string_builtins(&mut self) {
        ...
        // str_to_upper / str_to_lower / str_trim / str_trim_start / str_trim_end moved to
        // the STR_OUT_EXTERNS synthesis table (codegen/builtin_externs.rs) — R1d slice 2
