...
impl<'ctx> super::Codegen<'ctx> {
    ...
    pub(super) fn declare_string_builtins(&mut self) {
        ...
        // str_slice / str_repeat / str_replace / str_pad_start / str_pad_end moved to the
        // STR_OUT_EXTERNS synthesis table (codegen/builtin_externs.rs) — R1d slice 2
        // out-param-synthesis extension, second batch (multi-arg candidates). Was
        // previously hand-written here; see that file's StrOutSig doc comment.
